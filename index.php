...
<body>
    <nav class="bg-slate-900 text-7xl min-h-[3.8rem] max-h-[5.3rem]">
     ...
     <section class="admin-login">
        <a href="admin/"><button class="text-4xl bg-slate-700 rounded-lg p-2 hover:text-slate-300 text-gray-100 relative bottom-[6.5rem] left-[92rem]">Admin Login</button>
        </a>
     </section>
     <div>
