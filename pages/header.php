<nav class="bg-slate-900 bg-opacity-80 grid  text-6xl py-5 z-10 montserrat-600 transition-all duration-500 grid-cols-10   ">
    <div class="menu col-span-1 p-3 h-full px-4 cursor-pointer " id="menu">
        ...
        <div class="text-gray-300 col-span-9 text-end  navText transition-all duration-500  px-auto md:text-center md:pr-5 md:py-2">Indian Knowledge System
